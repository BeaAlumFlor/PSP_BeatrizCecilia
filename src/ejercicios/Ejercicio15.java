...
public class Ejercicio15 {
	...
	public static void main(String[] args) {
		...
		System.out.println("En una circunferencia de radio "+ radio + "cm, el diámetro es "+ calculoDiametro(radio) + "cm, su áres es " + calculoArea(radio) + "cm\u00B2 y el volumen de su esfera " + calculoVolumen(radio) + "cm\u00B3." );
		
		teclado.close();
	}
		
	public static double calculoVolumen(double r) {
		double volumen = Math.round(((Math.PI * 4 * Math.pow(r, 3))/3) * 1000)/1000.0;
		return volumen;
	}
